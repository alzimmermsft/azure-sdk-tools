...
import com.azure.tools.apiview.processor.diagnostics.rules.BadAnnotationDiagnosticRule;
import com.azure.tools.apiview.processor.diagnostics.rules.BuilderTraitsDiagnosticRule;
import com.azure.tools.apiview.processor.diagnostics.rules.ConsiderFinalClassDiagnosticRule;
import com.azure.tools.apiview.processor.diagnostics.rules.ExpandableStringEnumDiagnosticRule;
...
import com.azure.tools.apiview.processor.diagnostics.rules.UpperCaseEnumValuesDiagnosticRule;
...
public class Diagnostics {
    ...
    public Diagnostics() {
        ...
        diagnostics.add(new IllegalMethodNamesDiagnosticRule(new Rule("Builder$", "tokenCredential"),
            // it should just be 'credential'
            new Rule("Builder$", "^set"),            // we shouldn't have setters in the builder
            new Rule("^isHas"), new Rule("^setHas")));
        ...
        diagnostics.add(new BadAnnotationDiagnosticRule(new BadAnnotation("JacksonXmlRootElement",
        ...
        diagnostics.add(new RequiredBuilderMethodsDiagnosticRule(null).add("configuration",
                new ExactTypeNameCheckFunction("Configuration"))
            .add("clientOptions", new ExactTypeNameCheckFunction("ClientOptions"))
            .add("connectionString", new ExactTypeNameCheckFunction("String"))
            .add("credential", new ExactTypeNameCheckFunction(
                new ParameterAllowedTypes("TokenCredential", "AzureKeyCredential", "AzureSasCredential",
        ...
        diagnostics.add(new RequiredBuilderMethodsDiagnosticRule("amqp").add("proxyOptions",
                new ExactTypeNameCheckFunction("ProxyOptions"))
        ...
        diagnostics.add(new RequiredBuilderMethodsDiagnosticRule("http").add("addPolicy",
                new ExactTypeNameCheckFunction("HttpPipelinePolicy"))
